			...
			'body-color' => array(
				...
				'options' => array(
					...
					'page-title-background-gradient-max-opacity' => array(
						'title' => esc_html__('Page Title Background Gradient Max Opacity', 'infinite'),
						'type' => 'text',
						'default' => '1',
						'description' => esc_html__('Fill the number between 0.01 to 1', 'infinite')
					),
					'page-title-background-gradient-color' => array(
						'title' => esc_html__('Page Title Background Gradient Color', 'infinite'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'selector-extra' => true,
						'selector' => '.infinite-page-title-wrap .infinite-page-title-top-gradient{ ' .
			...
			'sidebar-color' => array(
				...
				'options' => array(	
					...
					'tag-cloud-text-color' => array(
						'title' => esc_html__('Tag Cloud Text Color', 'infinite'),
						'type' => 'colorpicker',
						'selector' => '.infinite-body .tagcloud a, .infinite-body .tagcloud a:hover{ color: #gdlr#; }'
					),
					'tag-cloud-background-color' => array(
						'title' => esc_html__('Tag Cloud Background Color', 'infinite'),
						'type' => 'colorpicker',
						'selector' => '.infinite-body .tagcloud a{ background-color: #gdlr#; }'
					),
					'tag-cloud-border-color' => array(
						'title' => esc_html__('Tag Cloud Border Color', 'infinite'),
						'type' => 'colorpicker',
						'selector' => '.infinite-body .tagcloud a{ border-color: #gdlr#; }'
					),
					...
					'custom-menu-widget-list-style-link' => array(
						'title' => esc_html__('Custom Menu Widget List Style Link Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#6774a2',
					...
					'custom-menu-widget-list-style-link-hover' => array(
						'title' => esc_html__('Custom Menu Widget List Style Link Hover Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#1c3375',
					...
					'custom-menu-widget-list-style-border' => array(
						'title' => esc_html__('Custom Menu Widget List Style Border', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#233c85',
			...
			'single-blog' => array(
				...
				'options' => array(		
					...
					'single-blog-title-background-gradient-max-opacity' => array(
						'title' => esc_html__('Single Blog ( Main Title ) Background Gradient Max Opacity', 'infinite'),
						'type' => 'text',
						'default' => '1',
						'description' => esc_html__('Fill the number between 0.01 to 1', 'infinite')
					),
					'single-blog-title-background-gradient-color' => array(
						'title' => esc_html__('Single Blog ( Main Title ) Background Gradient Color', 'infinite'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'selector-extra' => true,
						'selector' => '.infinite-blog-title-wrap.infinite-feature-image .infinite-blog-title-top-overlay{ ' .
			...
			'element-3-color' => array(
				...
				'options' => array(
					...
					'personnel-modern-position-color' => array(
						'title' => esc_html__('Personnel Modern Position/Social', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
